...
# Shared orders file path
ORDERS_FILE_PATH = os.path.join(os.path.dirname(__file__), "orders.txt")
...
def load_orders():
    ...
    try:
        ...
        st.write(f"DEBUG: Reading from {ORDERS_FILE_PATH}")  # Debug line
